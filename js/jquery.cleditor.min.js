...
(function (n) {
    function vi(t) {
        ...
        if (!i.disabled && n(v).attr(r) !== r) {
            ...
            if (p === "source") l(i) ? (delete i.range, i.$area.hide(), i.$frame.show(), v.title = w.title) : (i.$frame.hide(), i.$area.show(), v.title = "Show Rich Text"), setTimeout(function () {
                ...
                if (p === "print") i.$frame[0].contentWindow.print();
                else if (!s(i, y.command, y.value, y.useCSS, v)) return !1
            }
            h(i)
        }
    }
    ...
    function s(n, i, r, u, f) {
        ...
        var e = !0,
            o;
        if (t && i.toLowerCase() === "inserthtml") p(n).pasteHTML(r);
        else {
            try {
    ...
    function ht(i) {
        ...
        var u = i.$frame = n('<iframe frameborder="0" src="javascript:true;" />').hide().appendTo(o),
            l = u[0].contentWindow,
            f = i.doc = l.document,
            s = n(f);
        f.open();
        ...
        t || ot ? (s.bind("beforedeactivate beforeactivate selectionchange keypress", function (n) {
            if (n.type === "beforedeactivate") i.inactive = !0;
                ...
                for (i.range || (i.range = []), i.range.unshift(p(i)); i.range.length > 2;) i.range.pop()
        }), u.focus(function () {
            it(i);
    ...
    function c(i) {
        ...
        n.each(i.$toolbar.find("." + vt), function (o, s) {
            ...
            if (i.disabled) l = !1;
                ...
                command: h.command,
                useCSS: i.options.useCSS
            }, l = h.getEnabled(y), l === undefined && (l = !0);
            else if ((e || st) && h.name !== "source" || t && (c === "undo" || c === "redo")) l = !1;
            else if (c && c !== "print" && (t && c === "hilitecolor" && (c = "backcolor"), !t || c !== "inserthtml")) try {
    ...
    n.cleditor = {
        defaultOptions: {
            ...
            docCSSFile: "",
            bodyStyle: "margin:4px; font:16px Arial,Verdana; cursor:text;color:#fff;"
        },
        buttons: {
    ...
    var ft = "backgroundColor",
        ...
        t = /msie/.test(v),
        li = /msie\s6/.test(v),
        ot = /(trident)(?:.*rv:([\w.]+))?/.test(v),
        ai = /webkit/.test(v),
        st = /iphone|ipad|ipod/i.test(v),
        f = {},
        wt, o = n.cleditor.buttons;
    ...
    cleditor = function (r, f) {
        ...
        var l = s.$area = n(r).hide().data(lt, s).blur(function () {
            ...
            v = s.$main = n(i).addClass(fi).width(f.width).height(f.height),
            y = s.$toolbar = n(i).addClass(ei).appendTo(v),
